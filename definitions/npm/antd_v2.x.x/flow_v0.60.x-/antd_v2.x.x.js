...
declare module "antd" {
  ...
  declare export interface AbstractInputProps {
    prefixCls?: string;
    className?: string;
    defaultValue?: any;
    value?: any;
  ...
  declare export interface InputProps extends AbstractInputProps {
    placeholder?: string;
    type?: string;
    id?: number | string;
    name?: string;
  ...
  declare export interface SearchProps extends InputProps {
  ...
  declare export interface TextAreaProps extends AbstractInputProps {
  ...
  declare export type ValidateCallback<T> = (errors: any, values: T) => void;
  ...
  declare export type UploadFileStatus =
    | "error"
    | "success"
    | "done"
    | "uploading"
  ...
  declare export interface CheckboxGroupProps
    extends AbstractCheckboxGroupProps {
  ...
  declare export interface AbstractCheckboxProps {
    ...
    onMouseEnter?: SyntheticEvent<any>;
    onMouseLeave?: SyntheticEvent<any>;
    value?: any;
    name?: string;
    children?: React.Node;
  }
  ...
  declare export interface DropdownButtonProps
    extends ButtonGroupProps, DropDownProps {
    type?: "primary" | "ghost" | "dashed";
    disabled?: boolean;
    onClick?: SyntheticEvent<MouseEventHandler<any>>;
    children?: any;
  }
  ...
  declare export interface DatePickerProps
    extends PickerProps, SinglePickerProps {
    className?: string;
  ...
  declare export interface MonthPickerProps
    extends PickerProps, SinglePickerProps {
    className?: string;
    placeholder?: string;
  }
  ...
  declare export type SelectValue =
    | string
    | any[]
    | LabeledValue
    | LabeledValue[];
  ...
  declare class SelectionCheckboxAll extends React.Component<
  ...
  declare export class AntTreeNode extends React.Component<
    AntTreeNodeProps,
    {}
  > {}
  ...
  declare export interface StepProps {
    children?: React.ChildrenArray<
      React.ElementType<{ onChange?: (object: Object) => void }>
    >;
  }
